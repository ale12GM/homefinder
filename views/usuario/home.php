    ...
    <div class="container mx-auto flex justify-between items-center px-6 py-4">
      ...
      <nav id="menu" class="hidden md:flex md:items-center md:space-x-8 font-bold text-[#d29057] absolute md:static top-16 left-0 w-full md:w-auto bg-white md:bg-transparent p-6 md:p-0 shadow-md md:shadow-none">
        <ul class="flex flex-col md:flex-row gap-6 md:gap-8">
          <li><a href="#hero" class="hover:text-[#a66933]">Inicio</a></li> <!-- Apunta a la sección hero -->
          <li><a href="#sobre-nosotros" class="hover:text-[#a66933]">Sobre Nosotros</a></li> <!-- Apunta a la sección "Sobre Nosotros" -->
          <li><a href="#contacto" class="hover:text-[#a66933]">Contacto</a></li> <!-- Apunta a la sección "Contacto" -->

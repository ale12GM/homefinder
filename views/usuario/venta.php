...
<main class="p-4">
  <div class="max-w-[1400px] mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md transform transition duration-300 hover:scale-105 hover:shadow-xl flex flex-col">
        
        <!-- Imagen -->
        <?php if (!empty($p['imagen'])) { ?>
          <img src="/img/<?php echo $p['imagen']; ?>" alt="Imagen de la propiedad" 
        ...
        <div class="p-3 flex-1 flex flex-col justify-between" style="background-color: #5B674D; color: #FEFAE0;">
          <div>
            ...
            <p class="text-xs"><?php echo $p['descripcion']; ?></p>
          </div>
        </div>
      </div>
      <?php } ?>
